...
public class MembershipFunction {
    ...
    /**
     * Return the value where the input value would be at a maximum.
     *
     * @return double Max range value
     */
    public double getMaxRangeValue() {
        return (range[2] + range[1]) / 2.0D;
    }
    ...
    /**
     * Return 4 points of the trapezoid function.
     *
     * @return double[]
     */
