...
public class DashboardView extends VerticalLayout implements View {
    ...
    public DashboardView() {
        ...
        addComponent(top);
        final Label title = new Label("PineTree");
        ...
        HorizontalLayout symbolHL = new HorizontalLayout();
        symbolHL.setSpacing(true);
        TextField symbol = new TextField("Symbol");      
        symbol.setValue("AAPL");
        symbolHL.addComponent(symbol);
        
        final Button analyze = new Button("Analyze");
        analyze.addStyleName("default");
        symbolHL.addComponent(analyze);
        ...
        row.addComponent(createPanel(symbolHL));
