...
import com.bhaga.pinetree.ui.data.Generator;
import com.bhaga.pinetree.ui.data.MyConverterFactory;
...
public class DashboardUI extends UI {
    ...
    private void buildLoginView(boolean exit) {
        ...
        Label title = new Label("PineTree");
        ...
        signin.addClickListener(new ClickListener() {
            ...
            public void buttonClick(ClickEvent event) {
                if (username.getValue() != null
                        && username.getValue().equals(DataProvider.Config.USER)
                        && password.getValue() != null
                        && password.getValue().equals(DataProvider.Config.PASSWORD)) {
                        ...
                        addComponent(new VerticalLayout() {
                            {
                                ...
                                Label userName = new Label(DataProvider.Config.USER_FIRST_NAME
                                        + " "
                                        + DataProvider.Config.USER_LAST_NAME);
