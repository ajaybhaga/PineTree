...
public class ConnectorBundleLoaderImpl extends com.vaadin.client.metadata.ConnectorBundleLoader {
  public void init() {
    addAsyncBlockLoader(new AsyncBundleLoader("__eager", new String[] {"com.vaadin.ui.Embedded","com.vaadin.ui.OptionGroup","com.vaadin.ui.PasswordField","com.vaadin.ui.Tree","com.vaadin.ui.DateField","com.vaadin.ui.CustomField","com.vaadin.ui.TabSheet","com.vaadin.ui.CssLayout","com.vaadin.ui.AbsoluteLayout","com.vaadin.ui.Upload","com.vaadin.ui.TextArea","com.vaadin.ui.Panel","com.vaadin.ui.JavaScript","com.vaadin.ui.PopupView","com.vaadin.ui.Video","com.vaadin.ui.GridLayout","com.vaadin.ui.TextField","com.vaadin.ui.HorizontalSplitPanel","com.vaadin.ui.NativeSelect","com.vaadin.ui.InlineDateField","com.vaadin.ui.AbstractJavaScriptComponent","com.vaadin.server.AbstractJavaScriptExtension","com.vaadin.ui.Slider","com.vaadin.ui.Label","com.vaadin.ui.CustomComponent","com.github.wolfie.refresher.Refresher","com.vaadin.ui.MenuBar","com.vaadin.ui.CheckBox","com.vaadin.ui.CustomLayout","org.vaadin.cssinject.CSSInject","com.vaadin.ui.Window","com.vaadin.ui.Link","com.vaadin.server.BrowserWindowOpener","com.vaadin.ui.HorizontalLayout","com.vaadin.ui.TreeTable","com.vaadin.server.FileDownloader","com.vaadin.ui.FormLayout","com.vaadin.ui.TwinColSelect","com.vaadin.ui.Button","com.vaadin.ui.ComboBox","com.vaadin.ui.Image","com.vaadin.ui.VerticalSplitPanel","com.cs.Chart","com.vaadin.ui.Flash","com.vaadin.ui.Form","com.vaadin.ui.DragAndDropWrapper","com.vaadin.ui.Accordion","com.vaadin.ui.VerticalLayout","com.vaadin.ui.ProgressIndicator","com.vaadin.ui.UI","com.vaadin.ui.ListSelect","com.vaadin.ui.Table","com.vaadin.ui.BrowserFrame","com.vaadin.ui.Audio","com.vaadin.ui.NativeButton",}) {
      protected void load(final com.vaadin.client.metadata.TypeDataStore store) {
        new com.google.gwt.core.client.RunAsyncCallback() {
          ...
          private void load() {
            ...
            store.setClass("com.cs.Chart", com.cs.gwt.client.connect.JQChartConnector.class);
            ...
            store.setConstructor(com.cs.gwt.client.shared.JQChartState.class, new Invoker() {
              public Object invoke(Object target, Object[] params) {
                return com.google.gwt.core.client.GWT.create(com.cs.gwt.client.shared.JQChartState.class);
              }
            });
            ...
            store.setConstructor(com.cs.gwt.client.GwtJQChart.class, new Invoker() {
              public Object invoke(Object target, Object[] params) {
                return com.google.gwt.core.client.GWT.create(com.cs.gwt.client.GwtJQChart.class);
              }
            });
            ...
            store.setConstructor(com.cs.gwt.client.connect.JQChartConnector.class, new Invoker() {
              public Object invoke(Object target, Object[] params) {
                return com.google.gwt.core.client.GWT.create(com.cs.gwt.client.connect.JQChartConnector.class);
              }
            });
          ...
          private void load0() {
            ...
            store.setReturnType(com.cs.gwt.client.connect.JQChartConnector.class, "getWidget", new Type(com.cs.gwt.client.GwtJQChart.class));
            store.setReturnType(com.cs.gwt.client.connect.JQChartConnector.class, "getState", new Type(com.cs.gwt.client.shared.JQChartState.class));
          ...
          private void load1() {
            ...
            store.setParamTypes(com.cs.gwt.client.connect.JQChartServerRpc.class, "onValueChanged", new Type[] {new Type(java.lang.String.class), });
            ...
            store.setProxyHandler(com.cs.gwt.client.connect.JQChartServerRpc.class, new com.vaadin.client.metadata.ProxyHandler() {
              public Object createProxy(final com.vaadin.client.metadata.InvokationHandler handler) {
                return new com.cs.gwt.client.connect.JQChartServerRpc() {
                  public void onValueChanged(java.lang.String p0) {
                    handler.invoke(this, com.vaadin.client.metadata.TypeData.getType(com.cs.gwt.client.connect.JQChartServerRpc.class).getMethod("onValueChanged"), new Object [] {p0, });
                  }
                };
              }
            });
            ...
            store.setProperties(com.vaadin.shared.ui.textfield.AbstractTextFieldState.class, new String[] {"hideErrors", "modified", "width", "errorMessage", "readOnly", "height", "maxLength", "inputPrompt", "immediate", "id", "propertyReadOnly", "caption", "required", "resources", "columns", "styles", "description", "registeredEventListeners", "text", "tabIndex", "primaryStyleName", "enabled", });
            store.setProperties(com.vaadin.shared.ui.checkbox.CheckBoxState.class, new String[] {"registeredEventListeners", "hideErrors", "width", "id", "height", "checked", "resources", "errorMessage", "immediate", "primaryStyleName", "required", "readOnly", "styles", "propertyReadOnly", "modified", "description", "enabled", "caption", "tabIndex", });
            store.setProperties(com.vaadin.shared.ui.menubar.MenuBarState.class, new String[] {"primaryStyleName", "styles", "errorMessage", "height", "description", "readOnly", "id", "caption", "resources", "width", "immediate", "enabled", "registeredEventListeners", });
            store.setProperties(com.vaadin.shared.ui.csslayout.CssLayoutState.class, new String[] {"width", "immediate", "styles", "resources", "enabled", "description", "id", "readOnly", "errorMessage", "primaryStyleName", "registeredEventListeners", "childCss", "caption", "height", });
            store.setProperties(com.vaadin.shared.ui.tree.TreeState.class, new String[] {"id", "hideErrors", "resources", "primaryStyleName", "width", "enabled", "caption", "styles", "registeredEventListeners", "modified", "description", "immediate", "propertyReadOnly", "tabIndex", "height", "required", "readOnly", "errorMessage", });
            store.setProperties(com.vaadin.shared.ui.button.NativeButtonState.class, new String[] {"height", "id", "width", "description", "registeredEventListeners", "resources", "immediate", "readOnly", "errorMessage", "clickShortcutKeyCode", "enabled", "caption", "tabIndex", "primaryStyleName", "htmlContentAllowed", "styles", "disableOnClick", });
            store.setProperties(com.vaadin.shared.AbstractFieldState.class, new String[] {"enabled", "height", "caption", "required", "width", "primaryStyleName", "modified", "description", "registeredEventListeners", "readOnly", "styles", "id", "propertyReadOnly", "tabIndex", "hideErrors", "resources", "errorMessage", "immediate", });
            store.setProperties(com.vaadin.shared.ui.flash.FlashState.class, new String[] {"resources", "classId", "enabled", "height", "standby", "primaryStyleName", "registeredEventListeners", "codebase", "alternateText", "embedParams", "width", "description", "codetype", "errorMessage", "immediate", "id", "readOnly", "archive", "caption", "styles", });
            store.setProperties(com.vaadin.shared.ui.orderedlayout.HorizontalLayoutState.class, new String[] {"immediate", "registeredEventListeners", "childData", "id", "resources", "caption", "styles", "width", "description", "readOnly", "height", "marginsBitmask", "errorMessage", "primaryStyleName", "enabled", "spacing", });
            store.setProperties(com.vaadin.shared.ui.orderedlayout.VerticalLayoutState.class, new String[] {"width", "enabled", "styles", "primaryStyleName", "description", "errorMessage", "readOnly", "id", "immediate", "spacing", "height", "registeredEventListeners", "resources", "caption", "childData", "marginsBitmask", });
            store.setProperties(com.vaadin.shared.ui.optiongroup.OptionGroupState.class, new String[] {"caption", "primaryStyleName", "id", "width", "enabled", "registeredEventListeners", "required", "immediate", "resources", "hideErrors", "height", "tabIndex", "description", "propertyReadOnly", "modified", "errorMessage", "readOnly", "styles", });
            store.setProperties(com.vaadin.shared.ui.BrowserWindowOpenerState.class, new String[] {"uriFragment", "styles", "caption", "description", "width", "readOnly", "registeredEventListeners", "id", "features", "target", "errorMessage", "enabled", "height", "resources", "primaryStyleName", "parameters", "immediate", });
            store.setProperties(com.cs.gwt.client.shared.JQChartState.class, new String[] {"lastUpdateTime", "caption", "id", "errorMessage", "primaryStyleName", "description", "resources", "refreshJS", "uuid", "enabled", "clickJS", "initJS", "readOnly", "height", "width", "styles", "registeredEventListeners", "immediate", "dataClickJS", });
            store.setProperties(com.vaadin.shared.ui.splitpanel.AbstractSplitPanelState.SplitterState.class, new String[] {"positionUnit", "maxPositionUnit", "positionReversed", "maxPosition", "locked", "position", "minPosition", "minPositionUnit", });
            store.setProperties(com.vaadin.shared.ui.progressindicator.ProgressIndicatorState.class, new String[] {"caption", "hideErrors", "enabled", "errorMessage", "immediate", "resources", "tabIndex", "id", "modified", "readOnly", "required", "pollingInterval", "height", "width", "indeterminate", "propertyReadOnly", "description", "state", "primaryStyleName", "registeredEventListeners", "styles", });
            store.setProperties(com.vaadin.shared.ui.twincolselect.TwinColSelectState.class, new String[] {"propertyReadOnly", "modified", "required", "readOnly", "immediate", "enabled", "description", "caption", "id", "registeredEventListeners", "hideErrors", "height", "width", "tabIndex", "errorMessage", "resources", "styles", "primaryStyleName", });
            store.setProperties(com.vaadin.shared.ui.video.VideoState.class, new String[] {"enabled", "showControls", "description", "immediate", "resources", "readOnly", "altText", "htmlContentAllowed", "sources", "id", "height", "sourceTypes", "width", "autoplay", "errorMessage", "muted", "registeredEventListeners", "styles", "primaryStyleName", "caption", });
            store.setProperties(com.vaadin.shared.ui.customlayout.CustomLayoutState.class, new String[] {"immediate", "templateName", "id", "styles", "height", "readOnly", "resources", "templateContents", "errorMessage", "width", "description", "registeredEventListeners", "enabled", "caption", "primaryStyleName", "childLocations", });
            load2();
          }
          private void load2() {
            store.setProperties(com.vaadin.shared.ui.AbstractMediaState.class, new String[] {"showControls", "muted", "styles", "description", "id", "resources", "altText", "height", "primaryStyleName", "width", "immediate", "errorMessage", "readOnly", "registeredEventListeners", "htmlContentAllowed", "autoplay", "sourceTypes", "sources", "enabled", "caption", });
            store.setProperties(com.vaadin.shared.ui.datefield.PopupDateFieldState.class, new String[] {"primaryStyleName", "readOnly", "registeredEventListeners", "height", "id", "propertyReadOnly", "resources", "textFieldEnabled", "tabIndex", "immediate", "required", "errorMessage", "hideErrors", "caption", "styles", "enabled", "width", "modified", "description", });
            store.setProperties(java.util.HashMap.class, new String[] {});
            store.setProperties(com.vaadin.shared.ui.tabsheet.TabsheetState.class, new String[] {"height", "immediate", "registeredEventListeners", "resources", "width", "readOnly", "description", "caption", "id", "primaryStyleName", "errorMessage", "styles", "enabled", });
            store.setProperties(com.vaadin.shared.ui.embedded.EmbeddedState.class, new String[] {"width", "immediate", "id", "registeredEventListeners", "alternateText", "readOnly", "caption", "primaryStyleName", "height", "description", "resources", "errorMessage", "styles", "enabled", });
            store.setProperties(com.vaadin.shared.ui.orderedlayout.AbstractOrderedLayoutState.class, new String[] {"errorMessage", "description", "spacing", "childData", "immediate", "registeredEventListeners", "caption", "id", "enabled", "primaryStyleName", "marginsBitmask", "width", "resources", "readOnly", "height", "styles", });
            store.setProperties(com.vaadin.shared.ui.textarea.TextAreaState.class, new String[] {"description", "primaryStyleName", "registeredEventListeners", "resources", "maxLength", "immediate", "wordwrap", "errorMessage", "styles", "caption", "id", "hideErrors", "height", "enabled", "rows", "readOnly", "required", "text", "tabIndex", "width", "modified", "inputPrompt", "columns", "propertyReadOnly", });
            store.setProperties(com.vaadin.shared.AbstractComponentState.class, new String[] {"readOnly", "height", "registeredEventListeners", "enabled", "caption", "styles", "immediate", "description", "errorMessage", "width", "id", "resources", "primaryStyleName", });
            store.setProperties(com.github.wolfie.refresher.shared.RefresherState.class, new String[] {"registeredEventListeners", "pollingInterval", "enabled", "resources", });
            store.setProperties(com.vaadin.shared.ui.panel.PanelState.class, new String[] {"readOnly", "scrollTop", "description", "registeredEventListeners", "primaryStyleName", "height", "errorMessage", "caption", "enabled", "styles", "width", "scrollLeft", "resources", "tabIndex", "immediate", "id", });
            store.setProperties(com.vaadin.shared.ui.popupview.PopupViewState.class, new String[] {"hideOnMouseOut", "description", "id", "resources", "height", "enabled", "registeredEventListeners", "immediate", "primaryStyleName", "html", "width", "readOnly", "caption", "errorMessage", "styles", });
            store.setProperties(com.vaadin.shared.ui.JavaScriptComponentState.class, new String[] {"caption", "primaryStyleName", "registeredEventListeners", "height", "immediate", "resources", "errorMessage", "callbackNames", "description", "styles", "enabled", "rpcInterfaces", "width", "readOnly", "id", });
            store.setProperties(com.vaadin.shared.JavaScriptExtensionState.class, new String[] {"callbackNames", "enabled", "rpcInterfaces", "registeredEventListeners", "resources", });
            ...
            store.setProperties(com.vaadin.shared.ui.combobox.ComboBoxState.class, new String[] {"id", "hideErrors", "propertyReadOnly", "immediate", "tabIndex", "readOnly", "styles", "enabled", "required", "errorMessage", "primaryStyleName", "caption", "registeredEventListeners", "height", "resources", "modified", "width", "description", });
            store.setProperties(com.vaadin.shared.ui.button.ButtonState.class, new String[] {"enabled", "disableOnClick", "id", "clickShortcutKeyCode", "description", "immediate", "caption", "errorMessage", "primaryStyleName", "readOnly", "resources", "height", "width", "styles", "registeredEventListeners", "htmlContentAllowed", "tabIndex", });
            store.setProperties(com.vaadin.shared.ui.link.LinkState.class, new String[] {"enabled", "styles", "height", "registeredEventListeners", "width", "primaryStyleName", "resources", "description", "immediate", "errorMessage", "readOnly", "id", "caption", });
            store.setProperties(com.vaadin.shared.ui.splitpanel.HorizontalSplitPanelState.class, new String[] {"height", "resources", "readOnly", "id", "splitterState", "secondChild", "styles", "firstChild", "registeredEventListeners", "immediate", "width", "caption", "errorMessage", "primaryStyleName", "enabled", "description", });
            store.setProperties(com.vaadin.shared.ui.window.WindowState.class, new String[] {"resources", "description", "centered", "positionX", "registeredEventListeners", "styles", "immediate", "positionY", "scrollTop", "height", "caption", "modal", "resizeLazy", "readOnly", "width", "scrollLeft", "enabled", "tabIndex", "resizable", "errorMessage", "id", "primaryStyleName", "draggable", });
            store.setProperties(com.vaadin.shared.ui.datefield.InlineDateFieldState.class, new String[] {"description", "styles", "required", "enabled", "resources", "registeredEventListeners", "primaryStyleName", "hideErrors", "width", "propertyReadOnly", "modified", "tabIndex", "height", "immediate", "readOnly", "errorMessage", "caption", "id", });
            store.setProperties(com.vaadin.shared.ui.splitpanel.VerticalSplitPanelState.class, new String[] {"firstChild", "immediate", "description", "errorMessage", "width", "registeredEventListeners", "splitterState", "resources", "height", "styles", "readOnly", "id", "enabled", "primaryStyleName", "secondChild", "caption", });
            ...
            store.setProperties(com.vaadin.shared.ui.absolutelayout.AbsoluteLayoutState.class, new String[] {"id", "primaryStyleName", "registeredEventListeners", "width", "readOnly", "caption", "connectorToCssPosition", "styles", "resources", "enabled", "errorMessage", "immediate", "height", "description", });
            store.setProperties(com.vaadin.shared.MouseEventDetails.class, new String[] {"relativeX", "relativeY", "clientY", "clientX", "altKey", "type", "button", "metaKey", "shiftKey", "ctrlKey", });
            store.setProperties(org.vaadin.cssinject.shared.CSSInjectState.class, new String[] {"registeredEventListeners", "enabled", "styles", "styleSheetId", "resources", });
            store.setProperties(com.vaadin.shared.ui.form.FormState.class, new String[] {"errorMessage", "resources", "modified", "primaryStyleName", "propertyReadOnly", "hideErrors", "required", "footer", "caption", "description", "enabled", "width", "layout", "height", "id", "registeredEventListeners", "styles", "tabIndex", "readOnly", "immediate", });
            store.setProperties(com.vaadin.shared.ui.slider.SliderState.class, new String[] {"readOnly", "enabled", "primaryStyleName", "minValue", "propertyReadOnly", "resources", "id", "hideErrors", "styles", "registeredEventListeners", "immediate", "value", "tabIndex", "width", "description", "maxValue", "errorMessage", "orientation", "required", "modified", "caption", "resolution", "height", });
            store.setProperties(com.vaadin.shared.ui.label.LabelState.class, new String[] {"registeredEventListeners", "primaryStyleName", "text", "immediate", "height", "enabled", "errorMessage", "caption", "resources", "styles", "width", "contentMode", "description", "id", "readOnly", });
            store.setProperties(com.vaadin.shared.extension.javascriptmanager.JavaScriptManagerState.class, new String[] {"names", "registeredEventListeners", "enabled", "resources", });
            store.setProperties(com.vaadin.shared.ui.table.TableState.class, new String[] {"tabIndex", "hideErrors", "height", "registeredEventListeners", "resources", "immediate", "caption", "styles", "propertyReadOnly", "primaryStyleName", "readOnly", "required", "errorMessage", "width", "description", "id", "enabled", "modified", });
            store.setProperties(com.vaadin.shared.ui.image.ImageState.class, new String[] {"caption", "styles", "id", "readOnly", "width", "enabled", "immediate", "height", "registeredEventListeners", "resources", "primaryStyleName", "errorMessage", "description", "alternateText", });
            ...
            store.setProperties(com.vaadin.shared.ui.gridlayout.GridLayoutState.class, new String[] {"rows", "caption", "description", "primaryStyleName", "immediate", "id", "columns", "height", "styles", "resources", "errorMessage", "spacing", "width", "registeredEventListeners", "childData", "readOnly", "enabled", "marginsBitmask", });
            store.setProperties(com.vaadin.shared.ui.ui.UIState.class, new String[] {"styles", "id", "enabled", "registeredEventListeners", "height", "caption", "readOnly", "resources", "errorMessage", "tabIndex", "immediate", "width", "primaryStyleName", "description", });
            store.setProperties(com.vaadin.shared.ui.treetable.TreeTableState.class, new String[] {"tabIndex", "description", "registeredEventListeners", "modified", "hideErrors", "height", "primaryStyleName", "caption", "errorMessage", "required", "immediate", "readOnly", "styles", "id", "resources", "enabled", "propertyReadOnly", "width", });
            store.setProperties(com.vaadin.shared.ui.browserframe.BrowserFrameState.class, new String[] {"enabled", "immediate", "registeredEventListeners", "errorMessage", "styles", "id", "height", "readOnly", "width", "description", "alternateText", "caption", "resources", "primaryStyleName", });
            ...
            store.setPropertyType(com.cs.gwt.client.shared.JQChartState.class, "styles", new Type("java.util.List", new Type[] {new Type(java.lang.String.class), }));
            ...
            store.setPropertyType(com.cs.gwt.client.shared.JQChartState.class, "width", new Type(java.lang.String.class));
            ...
            store.setPropertyType(com.cs.gwt.client.shared.JQChartState.class, "caption", new Type(java.lang.String.class));
            ...
            store.setPropertyType(com.cs.gwt.client.shared.JQChartState.class, "refreshJS", new Type(java.lang.String.class));
            ...
            store.setPropertyType(com.cs.gwt.client.shared.JQChartState.class, "enabled", new Type(java.lang.Boolean.class));
          ...
          private void load3() {
            ...
            store.setPropertyType(com.cs.gwt.client.shared.JQChartState.class, "description", new Type(java.lang.String.class));
            ...
            store.setPropertyType(com.cs.gwt.client.shared.JQChartState.class, "uuid", new Type(java.lang.String.class));
            ...
            store.setPropertyType(com.cs.gwt.client.shared.JQChartState.class, "dataClickJS", new Type(java.lang.String.class));
            ...
            store.setPropertyType(com.cs.gwt.client.shared.JQChartState.class, "readOnly", new Type(java.lang.Boolean.class));
            ...
            store.setPropertyType(com.cs.gwt.client.shared.JQChartState.class, "primaryStyleName", new Type(java.lang.String.class));
            ...
            store.setPropertyType(com.cs.gwt.client.shared.JQChartState.class, "id", new Type(java.lang.String.class));
          ...
          private void load4() {
            ...
            store.setPropertyType(com.cs.gwt.client.shared.JQChartState.class, "lastUpdateTime", new Type(java.lang.Long.class));
            ...
            store.setPropertyType(com.cs.gwt.client.shared.JQChartState.class, "registeredEventListeners", new Type("java.util.Set", new Type[] {new Type(java.lang.String.class), }));
            ...
            store.setPropertyType(com.cs.gwt.client.shared.JQChartState.class, "errorMessage", new Type(java.lang.String.class));
            ...
            store.setPropertyType(com.cs.gwt.client.shared.JQChartState.class, "initJS", new Type(java.lang.String.class));
          ...
          private void load5() {
            ...
            store.setPropertyType(com.cs.gwt.client.shared.JQChartState.class, "height", new Type(java.lang.String.class));
            ...
            store.setPropertyType(com.cs.gwt.client.shared.JQChartState.class, "resources", new Type("java.util.Map", new Type[] {new Type(java.lang.String.class), new Type(com.vaadin.shared.communication.URLReference.class), }));
            ...
            store.setPropertyType(com.cs.gwt.client.shared.JQChartState.class, "clickJS", new Type(java.lang.String.class));
            ...
            store.setPropertyType(com.cs.gwt.client.shared.JQChartState.class, "immediate", new Type(java.lang.Boolean.class));
          ...
          private void load6() {
            ...
            store.setSetter(com.cs.gwt.client.shared.JQChartState.class, "styles", new Invoker() {
              public Object invoke(Object bean, Object[] params) {
                ((com.cs.gwt.client.shared.JQChartState) bean).styles = (java.util.List)params[0];return null;
              }
            });
            ...
            store.setSetter(com.cs.gwt.client.shared.JQChartState.class, "width", new Invoker() {
              public Object invoke(Object bean, Object[] params) {
                ((com.cs.gwt.client.shared.JQChartState) bean).width = (java.lang.String)params[0];return null;
              }
            });
            ...
            store.setSetter(com.cs.gwt.client.shared.JQChartState.class, "caption", new Invoker() {
              public Object invoke(Object bean, Object[] params) {
                ((com.cs.gwt.client.shared.JQChartState) bean).caption = (java.lang.String)params[0];return null;
              }
            });
            ...
            store.setSetter(com.cs.gwt.client.shared.JQChartState.class, "refreshJS", new Invoker() {
              public Object invoke(Object bean, Object[] params) {
                ((com.cs.gwt.client.shared.JQChartState) bean).refreshJS = (java.lang.String)params[0];return null;
              }
            });
            ...
            store.setSetter(com.cs.gwt.client.shared.JQChartState.class, "enabled", new Invoker() {
              public Object invoke(Object bean, Object[] params) {
                ((com.cs.gwt.client.shared.JQChartState) bean).enabled = (java.lang.Boolean)params[0];return null;
              }
            });
          ...
          private void load7() {
            ...
            store.setSetter(com.cs.gwt.client.shared.JQChartState.class, "description", new Invoker() {
              public Object invoke(Object bean, Object[] params) {
                ((com.cs.gwt.client.shared.JQChartState) bean).description = (java.lang.String)params[0];return null;
              }
            });
          ...
          private void load8() {
            store.setSetter(com.cs.gwt.client.shared.JQChartState.class, "uuid", new Invoker() {
              public Object invoke(Object bean, Object[] params) {
                ((com.cs.gwt.client.shared.JQChartState) bean).uuid = (java.lang.String)params[0];return null;
              }
            });
            ...
            store.setSetter(com.cs.gwt.client.shared.JQChartState.class, "dataClickJS", new Invoker() {
              public Object invoke(Object bean, Object[] params) {
                ((com.cs.gwt.client.shared.JQChartState) bean).dataClickJS = (java.lang.String)params[0];return null;
              }
            });
            ...
            store.setSetter(com.cs.gwt.client.shared.JQChartState.class, "readOnly", new Invoker() {
              public Object invoke(Object bean, Object[] params) {
                ((com.cs.gwt.client.shared.JQChartState) bean).readOnly = (java.lang.Boolean)params[0];return null;
              }
            });
            ...
            store.setSetter(com.cs.gwt.client.shared.JQChartState.class, "primaryStyleName", new Invoker() {
              public Object invoke(Object bean, Object[] params) {
                ((com.cs.gwt.client.shared.JQChartState) bean).primaryStyleName = (java.lang.String)params[0];return null;
              }
            });
          ...
          private void load9() {
            ...
            store.setSetter(com.cs.gwt.client.shared.JQChartState.class, "id", new Invoker() {
              public Object invoke(Object bean, Object[] params) {
                ((com.cs.gwt.client.shared.JQChartState) bean).id = (java.lang.String)params[0];return null;
              }
            });
            ...
            store.setSetter(com.cs.gwt.client.shared.JQChartState.class, "lastUpdateTime", new Invoker() {
              public Object invoke(Object bean, Object[] params) {
                ((com.cs.gwt.client.shared.JQChartState) bean).lastUpdateTime = (java.lang.Long)params[0];return null;
              }
            });
          ...
          private void load10() {
            ...
            store.setSetter(com.cs.gwt.client.shared.JQChartState.class, "registeredEventListeners", new Invoker() {
              public Object invoke(Object bean, Object[] params) {
                ((com.cs.gwt.client.shared.JQChartState) bean).registeredEventListeners = (java.util.Set)params[0];return null;
              }
            });
            ...
            store.setSetter(com.cs.gwt.client.shared.JQChartState.class, "errorMessage", new Invoker() {
              public Object invoke(Object bean, Object[] params) {
                ((com.cs.gwt.client.shared.JQChartState) bean).errorMessage = (java.lang.String)params[0];return null;
              }
            });
          ...
          private void load11() {
            ...
            store.setSetter(com.cs.gwt.client.shared.JQChartState.class, "initJS", new Invoker() {
              public Object invoke(Object bean, Object[] params) {
                ((com.cs.gwt.client.shared.JQChartState) bean).initJS = (java.lang.String)params[0];return null;
              }
            });
            ...
            store.setSetter(com.cs.gwt.client.shared.JQChartState.class, "height", new Invoker() {
              public Object invoke(Object bean, Object[] params) {
                ((com.cs.gwt.client.shared.JQChartState) bean).height = (java.lang.String)params[0];return null;
              }
            });
          ...
          private void load12() {
            ...
            store.setSetter(com.cs.gwt.client.shared.JQChartState.class, "resources", new Invoker() {
              public Object invoke(Object bean, Object[] params) {
                ((com.cs.gwt.client.shared.JQChartState) bean).resources = (java.util.Map)params[0];return null;
              }
            });
            ...
            store.setSetter(com.cs.gwt.client.shared.JQChartState.class, "clickJS", new Invoker() {
              public Object invoke(Object bean, Object[] params) {
                ((com.cs.gwt.client.shared.JQChartState) bean).clickJS = (java.lang.String)params[0];return null;
              }
            });
          ...
          private void load13() {
            ...
            store.setSetter(com.cs.gwt.client.shared.JQChartState.class, "immediate", new Invoker() {
              public Object invoke(Object bean, Object[] params) {
                ((com.cs.gwt.client.shared.JQChartState) bean).immediate = (java.lang.Boolean)params[0];return null;
              }
            });
            ...
            store.setGetter(com.cs.gwt.client.shared.JQChartState.class, "styles", new Invoker() {
              public Object invoke(Object bean, Object[] params) {
                return ((com.cs.gwt.client.shared.JQChartState) bean).styles;
              }
            });
            ...
            store.setGetter(com.cs.gwt.client.shared.JQChartState.class, "width", new Invoker() {
              public Object invoke(Object bean, Object[] params) {
                return ((com.cs.gwt.client.shared.JQChartState) bean).width;
              }
            });
            ...
            store.setGetter(com.cs.gwt.client.shared.JQChartState.class, "caption", new Invoker() {
              public Object invoke(Object bean, Object[] params) {
                return ((com.cs.gwt.client.shared.JQChartState) bean).caption;
              }
            });
          ...
          private void load14() {
            ...
            store.setGetter(com.cs.gwt.client.shared.JQChartState.class, "refreshJS", new Invoker() {
              public Object invoke(Object bean, Object[] params) {
                return ((com.cs.gwt.client.shared.JQChartState) bean).refreshJS;
              }
            });
            ...
            store.setGetter(com.cs.gwt.client.shared.JQChartState.class, "enabled", new Invoker() {
              public Object invoke(Object bean, Object[] params) {
                return ((com.cs.gwt.client.shared.JQChartState) bean).enabled;
              }
            });
            ...
            store.setGetter(com.cs.gwt.client.shared.JQChartState.class, "description", new Invoker() {
              public Object invoke(Object bean, Object[] params) {
                return ((com.cs.gwt.client.shared.JQChartState) bean).description;
              }
            });
          ...
          private void load15() {
            ...
            store.setGetter(com.cs.gwt.client.shared.JQChartState.class, "uuid", new Invoker() {
              public Object invoke(Object bean, Object[] params) {
                return ((com.cs.gwt.client.shared.JQChartState) bean).uuid;
              }
            });
            ...
            store.setGetter(com.cs.gwt.client.shared.JQChartState.class, "dataClickJS", new Invoker() {
              public Object invoke(Object bean, Object[] params) {
                return ((com.cs.gwt.client.shared.JQChartState) bean).dataClickJS;
              }
            });
            ...
            store.setGetter(com.cs.gwt.client.shared.JQChartState.class, "readOnly", new Invoker() {
              public Object invoke(Object bean, Object[] params) {
                return ((com.cs.gwt.client.shared.JQChartState) bean).readOnly;
              }
            });
          ...
          private void load16() {
            ...
            store.setGetter(com.cs.gwt.client.shared.JQChartState.class, "primaryStyleName", new Invoker() {
              public Object invoke(Object bean, Object[] params) {
                return ((com.cs.gwt.client.shared.JQChartState) bean).primaryStyleName;
              }
            });
            ...
            store.setGetter(com.cs.gwt.client.shared.JQChartState.class, "id", new Invoker() {
              public Object invoke(Object bean, Object[] params) {
                return ((com.cs.gwt.client.shared.JQChartState) bean).id;
              }
            });
            ...
            store.setGetter(com.cs.gwt.client.shared.JQChartState.class, "lastUpdateTime", new Invoker() {
              public Object invoke(Object bean, Object[] params) {
                return ((com.cs.gwt.client.shared.JQChartState) bean).lastUpdateTime;
              }
            });
          ...
          private void load17() {
            ...
            store.setGetter(com.cs.gwt.client.shared.JQChartState.class, "registeredEventListeners", new Invoker() {
              public Object invoke(Object bean, Object[] params) {
                return ((com.cs.gwt.client.shared.JQChartState) bean).registeredEventListeners;
              }
            });
            ...
            store.setGetter(com.cs.gwt.client.shared.JQChartState.class, "errorMessage", new Invoker() {
              public Object invoke(Object bean, Object[] params) {
                return ((com.cs.gwt.client.shared.JQChartState) bean).errorMessage;
              }
            });
            ...
            store.setGetter(com.cs.gwt.client.shared.JQChartState.class, "initJS", new Invoker() {
              public Object invoke(Object bean, Object[] params) {
                return ((com.cs.gwt.client.shared.JQChartState) bean).initJS;
              }
            });
          ...
          private void load18() {
            ...
            store.setGetter(com.cs.gwt.client.shared.JQChartState.class, "height", new Invoker() {
              public Object invoke(Object bean, Object[] params) {
                return ((com.cs.gwt.client.shared.JQChartState) bean).height;
              }
            });
          ...
          private void load19() {
            ...
            store.setGetter(com.cs.gwt.client.shared.JQChartState.class, "resources", new Invoker() {
              public Object invoke(Object bean, Object[] params) {
                return ((com.cs.gwt.client.shared.JQChartState) bean).resources;
              }
            });
            ...
            store.setGetter(com.cs.gwt.client.shared.JQChartState.class, "clickJS", new Invoker() {
              public Object invoke(Object bean, Object[] params) {
                return ((com.cs.gwt.client.shared.JQChartState) bean).clickJS;
              }
            });
          ...
          private void load20() {
            ...
            store.setGetter(com.cs.gwt.client.shared.JQChartState.class, "immediate", new Invoker() {
              public Object invoke(Object bean, Object[] params) {
                return ((com.cs.gwt.client.shared.JQChartState) bean).immediate;
              }
            });
      ...
      protected void load(final com.vaadin.client.metadata.TypeDataStore store) {
        com.google.gwt.core.client.GWT.runAsync(new com.google.gwt.core.client.RunAsyncCallback() {
          ...
          private void load() {
            ...
            store.setProperties(com.vaadin.shared.ui.colorpicker.ColorPickerGradientState.class, new String[] {"immediate", "registeredEventListeners", "styles", "errorMessage", "id", "primaryStyleName", "caption", "description", "height", "readOnly", "resources", "cursorX", "cursorY", "enabled", "width", "bgColor", });
      ...
      protected void load(final com.vaadin.client.metadata.TypeDataStore store) {
        com.google.gwt.core.client.GWT.runAsync(new com.google.gwt.core.client.RunAsyncCallback() {
          ...
          private void load() {
            ...
            store.setProperties(com.vaadin.shared.ui.colorpicker.ColorPickerState.class, new String[] {"immediate", "width", "id", "popupVisible", "errorMessage", "styles", "description", "caption", "color", "enabled", "readOnly", "primaryStyleName", "resources", "showDefaultCaption", "registeredEventListeners", "htmlContentAllowed", "height", });
      ...
      protected void load(final com.vaadin.client.metadata.TypeDataStore store) {
        com.google.gwt.core.client.GWT.runAsync(new com.google.gwt.core.client.RunAsyncCallback() {
          ...
          private void load() {
            ...
            store.setProperties(com.vaadin.shared.ui.colorpicker.ColorPickerGridState.class, new String[] {"rowCount", "resources", "caption", "registeredEventListeners", "readOnly", "width", "changedX", "changedY", "changedColor", "immediate", "description", "styles", "id", "columnCount", "errorMessage", "primaryStyleName", "height", "enabled", });
