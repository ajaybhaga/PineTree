...
/**
 * Load the training data from an Encog file, produced during the "build
 * training step", and attempt to train.
 *
 * @author jeff
 *
 */
public class MarketTrain {
    ...
    public static void trainNetwork(BasicNetwork network, MLDataSet training, double error, boolean crossValidation) {
